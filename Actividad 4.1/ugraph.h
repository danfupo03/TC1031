...
public:
	...
	void loadGraph(int, int, std::ifstream&);
...
template <class Vertex>
void UMatrixGraph<Vertex>::loadGraph(int n, int m, std::ifstream& inputFile){
	int from, to;
	char letr;
...
template <class Vertex>
void UListGraph<Vertex>::loadGraph(int n, int m, std::ifstream& inputFile){
	int from, to;
	char letr;
